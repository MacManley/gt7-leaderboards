...
const fetchDataAndSaveToCsv = async (result, CarClass) => {
  try {
    ...
    await createManufacturerChart(manufacturerCounts);
...
const createManufacturerChart = async (manufacturerCounts) => {
    ...
    fs.writeFileSync('manufacturer_chart.png', imageBuffer);

    console.log('Chart saved as manufacturer_chart.png')
};
